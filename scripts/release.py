...
LEGACY_AUTHOR_MAP = {
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local IYARI runtime files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live IYARI
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/digital-services-llc/iyari",
    ...
    lines.append(f"# IYARI v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for IYARI. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="IYARI Release Tool")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"IYARI v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"IYARI v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'IYARI v{new_version} ({calver_date})' "
