"""
Security advisory checker for IYARI.
...
run in environments where the rest of IYARI failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — IYARI requires 3.10+ but defensive.
        return None
    try:
