...
TIPS = [
    ...
    "hermes mcp serve runs IYARI itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire IYARI home directory.",
    ...
    "hermes gateway install sets up IYARI as a system service (systemd/launchd).",
    ...
    "hermes acp runs IYARI as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    'hermes dashboard embeds the full IYARI TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'hermes import restores a full IYARI backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
...
# any project or none — IYARI is not a coding-only agent.
# ---------------------------------------------------------------------------
