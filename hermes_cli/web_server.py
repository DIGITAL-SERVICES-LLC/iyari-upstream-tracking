...
def _count_status_active_sessions() -> int:
    ...
    while another IYARI process is writing to it.
    """
...
def _fire_cron_job_for_profile(profile: str, job_id: str) -> bool:
    ...
    Scope both cron storage and the runtime IYARI home so the job's store,
    ...
    async def _serve():
        ...
        with server.capture_signals():
            ...
            if headless:
                ...
                print(f"  IYARI backend listening on {host}:{actual_port}")
            else:
