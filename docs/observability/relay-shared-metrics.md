...
into IYARI and does not require `hermes plugins enable
observability/nemo_relay`. IYARI remains importable without Relay on other
...
IYARI requires NeMo Relay 0.6.0 or later within the 0.6 release line. That
