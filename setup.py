...
IYARI (see website/docs/getting-started/platform-support.md). The
...
IYARI package derivation, so only that build may create an artifact.
...
_BLOCK_MESSAGE = (
    ...
    "IYARI is distributed via the shell installer, Docker image, or Nix.\n"
    ...
    "the IYARI Nix derivation sets HERMES_NIX_BUILD=1. If it does, file a bug."
)
