"""
A2A (Agent-to-Agent) plugin for IYARI.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes IYARI as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    ...
    print_info("Expose IYARI as an A2A-discoverable agent and call other A2A agents.")
