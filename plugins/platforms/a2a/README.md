# A2A — Agent-to-Agent protocol for IYARI
...
peer (another IYARI, LangChain, CrewAI, Google ADK, OpenClaw, …). Stdlib only —
...
When the `a2a` platform is enabled, IYARI serves a v1.0 Agent Card at
