...
Credential storage mirrors every other IYARI channel:
...
# registers IYARI as its own client_id.
...
# Default name of the project IYARI provisions for the operator.
DEFAULT_PROJECT_NAME = "IYARI"
...
def _auth_json_path() -> Path:
    """Resolve ``~/.hermes/auth.json`` honouring the active IYARI profile."""
    try:
