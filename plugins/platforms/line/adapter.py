"""
LINE Messaging API platform adapter for IYARI.
...
to IYARI. It deliberately ports the *strongest* idea from each into
...
def register(ctx) -> None:
    """Plugin entry point — called by the IYARI plugin system at startup."""
