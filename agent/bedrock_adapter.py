"""AWS Bedrock Converse API adapter for IYARI.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install IYARI with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When IYARI is installed editable into system Python, the system boto3
