...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your IYARI session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show IYARI session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running IYARI agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update IYARI to the latest version"},
        {"name": "restart", "description": "Gracefully restart the IYARI gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a IYARI session in it",
