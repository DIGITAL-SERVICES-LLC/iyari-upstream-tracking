#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the IYARI docs site.
...
LLM reads to learn what IYARI does.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use IYARI as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with IYARI", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with IYARI", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with IYARI", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with IYARI"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Digital Services LLC. A terminal-native "
    ...
    lines.append("")
    lines.append("Repo: https://github.com/digital-services-llc/iyari")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# IYARI — Full Documentation\n",
        (
            "This file is the entire IYARI documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using IYARI, Features, Messaging, Integrations, Guides, "
