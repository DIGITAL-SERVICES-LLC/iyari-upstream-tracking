...
sidebar_position: 30
title: "IYARI Relay"
description: "Connect IYARI to messaging platforms through a relay connector that owns the platform credentials — enrollment, capabilities, config, and troubleshooting"
---

# IYARI Relay (Connector)
...
IYARI Relay is not a chat platform itself — it is a **connector system** that
