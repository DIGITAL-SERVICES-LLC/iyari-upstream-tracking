...
| Version | `1.0.0` |
| Author | arceus77-7, enhanced by IYARI |
| License | MIT |
...
- `tmux` available for stable authenticated sessions during IYARI terminal calls (desktop app flow only)
...
### Service Account (recommended for IYARI)
...
## IYARI Execution Pattern (desktop app flow)

IYARI terminal commands are non-interactive by default and can lose auth context between calls.
