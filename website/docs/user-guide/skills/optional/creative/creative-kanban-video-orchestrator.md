...
short to a music video to an ASCII loop — in a IYARI Kanban pipeline that
...
3. **Generates** a setup script that creates IYARI profiles, project workspace, and the initial kanban task
...
For mapping role → which IYARI skills + toolsets it loads, see
...
3. Creates each IYARI profile via `hermes profile create --clone`
...
team-design JSON. See **[references/kanban-setup.md](https://github.com/digital-services-llc/iyari/blob/main/optional-skills/creative/kanban-video-orchestrator/references/kanban-setup.md)**
...
playbook, see **[references/monitoring.md](https://github.com/digital-services-llc/iyari/blob/main/optional-skills/creative/kanban-video-orchestrator/references/monitoring.md)**.
...
task graphs. See **[references/examples.md](https://github.com/digital-services-llc/iyari/blob/main/optional-skills/creative/kanban-video-orchestrator/references/examples.md)**.
