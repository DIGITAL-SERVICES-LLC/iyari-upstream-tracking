---
title: "IYARI Skill Authoring — Author in-repo SKILL.md files: frontmatter and structure"
sidebar_label: "IYARI Skill Authoring"
description: "Author in-repo SKILL.md files: frontmatter and structure"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# IYARI Skill Authoring
...
# Authoring IYARI-Agent Skills (in-repo)
...
author: Real Name (github-handle), IYARI
license: MIT
...
- Credit the **human first**, then "IYARI" as secondary collaborator: `Ben Barclay (benbarclay), IYARI`.
- Never `author: IYARI` alone for contributed skills — credit the human, not the tool, even (especially) when an agent drafted the text.
- Maintainer-authored skills: `Teknium (teknium1), IYARI`.
...
|---|---|
| IYARI tools + stdlib Python + cross-platform CLIs | `[linux, macos, windows]` |
...
3. **`author: IYARI` on a contributed skill.** Credit the human first.
...
- [ ] Body follows the modern section order; commands framed through IYARI tools
