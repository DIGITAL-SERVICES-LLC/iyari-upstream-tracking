---
title: "IYARI — Use, configure, theme, extend, and orchestrate IYARI"
sidebar_label: "IYARI"
description: "Use, configure, theme, extend, and orchestrate IYARI"
---
...
Use, configure, theme, extend, and orchestrate IYARI.
...
IYARI is an open-source AI agent framework by Digital Services LLC that runs in your terminal, a native desktop app, messaging platforms, and IDEs. It's in the same category as Claude Code (Anthropic), Codex (OpenAI), and OpenClaw — autonomous coding and task-execution agents that use tool calling to interact with your system. IYARI works with any LLM provider (OpenRouter, Anthropic, OpenAI, Google, DeepSeek, xAI, local models, and 20+ others) and runs on Linux, macOS, Windows, and WSL.

What makes IYARI different:

- **Self-improving through skills** — IYARI learns from experience by saving reusable procedures as skills that load into future sessions.
...
- **Profiles** — run multiple independent IYARI instances with isolated configs, sessions, skills, and memory.
...
This skill is a concise operating guide, not the complete source of truth for every IYARI feature. If a IYARI feature, command, or setting is not mentioned here or in a reference, do not treat that absence as evidence that it does not exist. Check the live repository and official docs before giving a negative answer.

Good verification targets:

- CLI commands: `hermes --help`, `hermes <command> --help`, and `hermes_cli/main.py`
- User documentation: https://hermes-agent.nousresearch.com/docs/
- Source tree: https://github.com/digital-services-llc/iyari
...
## Spawning Additional IYARI Instances

Run additional IYARI processes as fully independent subprocesses — separate sessions, tools, and environments.
...
IYARI uses prompt_toolkit, which requires a real terminal. Use tmux for interactive spawning:
...
- **"delegate_task is capped at N" reports** — see `references/delegate-task-concurrency-diagnosis.md`. Three real cap paths in IYARI; if none fired, the model is self-limiting and rationalising it as "the runtime caps."
