...
| Version | `2.5.1` |
| Author | Siqi Chen (@blader, https://github.com/blader/humanizer), ported by IYARI |
| License | MIT |
...
Also apply this skill to **your own** output when writing user-facing prose such as release notes, PR descriptions, docs, and summaries. IYARI's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in IYARI
