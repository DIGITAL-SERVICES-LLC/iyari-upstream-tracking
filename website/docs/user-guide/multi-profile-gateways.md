...
If you only run one IYARI agent, you don't need this page — see
...
[Connecting Desktop to Many IYARI Instances](./multi-connection-desktop.md).

## When to use this

You want this setup when you have two or more IYARI agents that should all
